...
<head>
  ...
  <title>KASIR RESTOURKIESH</title>
  ...
  <style>
    body {
      background-image: url('assets/img/resto.jpeg');
      background-size: cover;
      background-repeat: no-repeat;
      background-position: center center;
    }
    /* Dalam file CSS eksternal atau dalam tag <style> di dalam tag <head> */
.text-gray-900 {
 margin-top: 20px;
}
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    ...
                    <h1 class="h4 text-gray-900 mb-4">Welcome to Restourkiesh</h1>
